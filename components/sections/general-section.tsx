        ...
        <ScrollArea className="h-[1000px] md:h-[900px] p-6">
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <div className="space-y-4 p-4 bg-green-50 rounded-lg border border-green-100 mt-6">
                ...
                <p className="text-sm text-gray-700">
                  Think creatively about how your character's background, skills, and abilities might apply to different
                  situations. The most memorable moments often come from unexpected solutions!
                </p>
              </div>
            </div>
          </div>
