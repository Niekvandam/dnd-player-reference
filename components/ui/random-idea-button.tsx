  ...
  return (
    <div className="relative">
      ...
      {showIdea && currentIdea && (
        <div className="absolute top-full mt-2 right-0 w-80 bg-white border border-purple-200 rounded-lg shadow-lg p-4 z-10 animate-in fade-in slide-in-from-top-5">
